...
public class StockPrice {
	...
	public static Map<String, String> ExcelSheetData() throws EncryptedDocumentException, IOException {
		...
		FileInputStream file = new FileInputStream("C:\\Users\\ZIG COMPUTERS\\Desktop\\Stock3.xlsx");
	...
	public static Map<String, String> WebtableData() throws InterruptedException {
		...
		System.setProperty("web driver.chrome.driver", "C:\\Rutu\\chromedriver_win32\\chromedriver.exe");
